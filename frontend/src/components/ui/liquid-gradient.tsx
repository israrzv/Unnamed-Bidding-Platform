...
export type LiquidGradientCanvasHandle = {
...
>(function LiquidGradientCanvas(props, ref) {
  ...
  const paramsRef = useRef({
    colors, speed, scale, seed, turbAmp, turbFreq, turbIter, waveFreq,
    distBias, jellify, ditherMode, dither, exposure, contrast, saturation,
    loop, maxDpr, fps,
  });
  paramsRef.current = {
    colors, speed, scale, seed, turbAmp, turbFreq, turbIter, waveFreq,
