...
/** Plain, classic sign-in card used inside the app (nav "Sign in" button). */
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-sm rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 shadow-2xl backdrop-blur-sm">
        ...
        <p className="mt-1 text-sm text-zinc-400">Sign in to your BidFair account.</p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-3">
          <input
            ...
            className="w-full rounded-lg border border-zinc-700 bg-zinc-950/60 px-4 py-2.5 text-white placeholder:text-zinc-500 outline-none focus:border-emerald-400/60"
          />
          <input
            name="password"
            type="password"
        ...
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-zinc-700 bg-zinc-950/60 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-zinc-800/60 disabled:opacity-60"
        >
